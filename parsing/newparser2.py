...
def get_cong_member_info(last_name, mods_file_path):
    ...
    if matched_cong_member_tag == None:
        ...
        return {'speaker_id': float(get_authority_id(matched_cong_member_tag)), 
                ...
                'congress_id': float(get_congress_id(matched_cong_member_tag))}
    ...
    def get_speaker_id(last_name, mods_file_path):
        ...
        if possible_speakers.shape[0] == 0:
            ...
            if int(mods_speaker_id) > 100000:
                ...
                # log("                " + str(mods_file_path))
                return None
            matched_speaker = possible_speakers[possible_speakers['speaker_id'] == float(mods_speaker_id)]
